    ...
    <div className="homepage">
      <header className="w-100 min-vh-100 d-flex align-items-center overflow-hidden">
        <Container>
          <Row className='header-box d-flex align-items-center pt-lg-5'>
            ...
            <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum quaerat praesentium magnam nostrum consectetur cum?</p>
      ...
      <Container>
        ...
        <Row>
          ...
          <button className='btn btn-success rounded-5 btn-lg' onClick={()=> {navigate("/kelas")}} data-aos="fade-up" data-aos-duration="1000">Lihat Semua Kelas <i className='fa-solid fa-chevron-right ms-1' ></i></button>
